...
describe('Notifications storage', () => {
  ...
  describe('normalizeNotification edge cases', () => {
    it('rejects null/undefined/primitive inputs', async () => {
      ...
      const { listNotifications } = await import('@/main/storage/notifications');
  ...
  describe('Auto-read logic', () => {
    ...
    it('respects explicit readAt', async () => {
      ...
      const unreadSuccess = list.find(n => n.title === 'Unread Success (Explicit)');
  ...
  describe('Public API', () => {
    it('addNotification adds and persists', async () => {
      const { addNotification, listNotifications } = await import('@/main/storage/notifications');
    ...
    it('markNotificationRead updates readAt', async () => {
      mockStoreMap.set('notifications', [
        { id: '1', title: 'Error', type: 'error', readAt: null, createdAt: 1000 }
      ]);
      const { markNotificationRead, listNotifications } = await import('@/main/storage/notifications');
    ...
    it('markAllNotificationsRead updates all null readAt', async () => {
      ...
      const { markAllNotificationsRead, listNotifications } = await import('@/main/storage/notifications');
    ...
    it('clearNotifications empties the store', async () => {
      ...
      const { clearNotifications, listNotifications } = await import('@/main/storage/notifications');
